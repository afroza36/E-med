    ...
    if(strlen($_SESSION['login'])==0)
    {
        ...
        if(isset($_POST['submit']))
        {
            ...
            if (isset($_POST['pass'])) {
                ...
                $start = $_POST['start'];
                $end = $_POST['end'];
                $query=mysqli_query($con,"update doctors set name='$name', email = '$email', contact_no='$contact', speciality='$specialization', visit_fee ='$fee', chamber_time_start = '$start', chamber_time_end = '$end' where id='".$_SESSION['id']."'");
                if($query)
                {
